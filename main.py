...
func = lambda x, order: quadratic( H, b, x, order )
...
x = bisection( weird, -100, 100, eps, maximum_iterations)
print('Optimum of the weird function found by bisection', x)

x, values, runtimes, gd_xs = gradient_descent( weird, 0.0, eps, maximum_iterations, exact_line_search )
print('Optimum of the weird function found by GD with exact line search', x)

x, values, runtimes, gd_xs = newton( weird, 0.0, eps, maximum_iterations, exact_line_search )
print('Optimum of the weird function found by Newton with exact line search', x)

x, values, runtimes, gd_xs = gradient_descent(weird, 0.0, eps, maximum_iterations, backtracking_line_search )
